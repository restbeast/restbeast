...
func Test_gofakeitCreditCardNumberImpl(t *testing.T) {
	...
	tests := []struct {
		...
		{true, "discover", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("discover")})}, cty.String}, false, "^65[4-9][0-9]{13}|64[4-9][0-9]{13}|6011[0-9]{12}|(622(?:12[6-9]|1[3-9][0-9]|[2-8][0-9][0-9]|9[01][0-9]|92[0-5])[0-9]{10})$"},
		...
		{true, "maestro", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("maestro")})}, cty.String}, false, "^(50|5[6-9]|6[0-9])[0-9]{10,17}$"},
