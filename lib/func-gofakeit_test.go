...
func Test_gofakeitDateRangeImpl(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"success", args{
				[]cty.Value{cty.StringVal("1941-02-27T00:00:00+00:00"), cty.StringVal("2018-08-26T00:00:00+00:00")}, cty.String,
			}, false,
		},
	}
...
func Test_gofakeitCreditCardNumberImpl(t *testing.T) {
	...
	tests := []struct {
		...
		{
			false, "visa", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("visa")})}, cty.String}, false,
			"^4[0-9]{12}(?:[0-9]{3})?",
		},
		{
			false, "mastercard", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("mastercard")})}, cty.String}, false,
			"^(5[1-5][0-9]{14}|2(22[1-9][0-9]{12}|2[3-9][0-9]{13}|[3-6][0-9]{14}|7[0-1][0-9]{13}|720[0-9]{12}))$",
		},
		{
			false, "american-express",
			args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("american-express")})}, cty.String}, false,
			"^3[47][0-9]{13}$",
		},
		{
			true, "diners-club", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("diners-club")})}, cty.String}, false,
			"^3(?:0[0-5]|[68][0-9])[0-9]{11}$",
		},
		{
			true, "discover", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("discover")})}, cty.String}, false,
			"^65[4-9][0-9]{13}|64[4-9][0-9]{13}|6011[0-9]{12}|(622(?:12[6-9]|1[3-9][0-9]|[2-8][0-9][0-9]|9[01][0-9]|92[0-5])[0-9]{10})$",
		},
		{
			true, "jcb", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("jcb")})}, cty.String}, false,
			"^(?:2131|1800|35\\d{3})\\d{11}$",
		},
		{
			true, "unionpay", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("unionpay")})}, cty.String}, false,
			"^(62[0-9]{14,17})$",
		},
		{
			true, "maestro", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("maestro")})}, cty.String}, false,
			"^(50|5[6-9]|6[0-9])[0-9]{10,17}$",
		},
		{
			true, "elo", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("elo")})}, cty.String}, false,
		...
		{
			false, "hipercard", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("hipercard")})}, cty.String}, false,
			"^(606282\\d{10}(\\d{3})?)|(3841\\d{15})$",
		},
		{
			false, "visa with binlist", args{
				[]cty.Value{
					cty.ListVal([]cty.Value{cty.StringVal("visa")}), cty.ListVal([]cty.Value{cty.StringVal("400115")}),
				}, cty.String,
			}, false, "^400115[0-9]{7}(?:[0-9]{3})?",
		},
		{
			false, "visa with binlist with gaps", args{
				[]cty.Value{
					cty.ListVal([]cty.Value{cty.StringVal("visa")}), cty.ListVal([]cty.Value{cty.StringVal("400115")}),
					cty.BoolVal(true),
				}, cty.String,
			}, false, "^4[0-9]{12}(?:[0-9]{3})?",
		},
		{
			false, "visa with binlist without gaps", args{
				[]cty.Value{
					cty.ListVal([]cty.Value{cty.StringVal("visa")}), cty.ListVal([]cty.Value{cty.StringVal("400115")}),
					cty.BoolVal(false),
				}, cty.String,
		...
		{
			false, "unknown", args{[]cty.Value{cty.ListVal([]cty.Value{cty.StringVal("unknown")})}, cty.String}, true,
			"^4[0-9]{12}(?:[0-9]{3})?",
		},
		{
