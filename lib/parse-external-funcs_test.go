...
func Test_prepParams1(t *testing.T) {
	...
	tests := []struct {
		...
		{"test1", args{[]string{"string", "string"}}, []function.Parameter{function.Parameter{Name: "arg0", Type: cty.String}, function.Parameter{Name: "arg1", Type: cty.String}}},
		{"test2", args{[]string{"list", "string"}}, []function.Parameter{function.Parameter{Name: "arg0", Type: cty.List(cty.DynamicPseudoType)}, function.Parameter{Name: "arg1", Type: cty.String}}},
		{"test3", args{[]string{"map", "string"}}, []function.Parameter{function.Parameter{Name: "arg0", Type: cty.Map(cty.DynamicPseudoType)}, function.Parameter{Name: "arg1", Type: cty.String}}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := prepParams(tt.args.args); !reflect.DeepEqual(got, tt.want) {
